    ...
    while True:
        ...
        with conn:
            while True:
                ...
                print(len(obj)/4)
                graph, names = convertData2graph(obj,10000,include_names=False)
                if graph is not None:
                        visualize_graph(graph, node_labels=names, save_graph_name=None, show_graph=True)
